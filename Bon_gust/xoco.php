        ...
        <div class="row">
            ...
            <div class="col-12 col-m-7">
                <div class="prod">
                    ...
                    $sql = "SELECT * from productes p  where p.id_categoria=2";
 ...
 <footer>
            <nav class="navbar navbar-expand-lg navbar-light m-2" style="background-color: #98E46C;">
                <div class="col-12 col-md-4">
                    <section>
                    <a class="navbar-brand" href="#"><img src="img/logo/bon_gust.png"  alt="" width="80" height="80"></a><br>
                ...
                <div class="lletres">
                    <div class="collapse navbar-collapse" >
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a href="productes.php" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-archive">Productes</a></i>
